&[
    ...
    ("ClearDefaultMapMode", Args::Args(&[]), void),
    ...
    ("GetActionLockInputText", Args::Args(&[]), CString),
    ...
    ("GetDynTrendMaxPadded", Args::Args(&[DType(Unknown)]), CFixedPoint),
    ("GetDynTrendMin", Args::Args(&[DType(Vic3(DataDynamicTrend))]), CFixedPoint),
    ("GetDynTrendMinPadded", Args::Args(&[DType(Unknown)]), CFixedPoint),
    ...
    ("GetMaxPadded", Args::Args(&[DType(Unknown)]), CFixedPoint),
    ...
    ("GetMinPadded", Args::Args(&[DType(Unknown)]), CFixedPoint),
    ...
    ("GetSelectedMapModeIcon", Args::Args(&[]), Unknown),
    ...
    ("HasDefaultMapMode", Args::Args(&[]), bool),
    ...
    ("HasMouseTendency", Args::Args(&[]), bool),
    ...
    ("TimerOrActionLock", Args::Args(&[]), bool),
    ...
    ("ToggleMapModeLock", Args::Args(&[]), void),

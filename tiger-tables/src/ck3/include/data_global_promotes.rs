&[
    ...
    ("CONFEDERATION_TYPE", Args::Args(&[]), Ck3(ConfederationType)),
    ...
    ("DYNASTY_HOUSE_2", Args::Args(&[]), Ck3(DynastyHouse)),
    ...
    ("GRAPHICAL_UNIT_TYPE", Args::Args(&[]), Ck3(GraphicalUnitType)),
    ("GREAT_HOLY_WAR", Args::Args(&[]), Ck3(GreatHolyWar)),
    ("GREAT_PROJECT", Args::Args(&[]), Ck3(GreatProject)),
    ("GREAT_PROJECT_CONTRIBUTION", Args::Args(&[]), Ck3(GreatProjectContribution)),
    ("GREAT_PROJECT_CONTRIBUTION_TYPE", Args::Args(&[]), Ck3(ProjectContributionType)),
    ("GREAT_PROJECT_TYPE", Args::Args(&[]), Ck3(GreatProjectType)),
    ...
    ("GetAgentSlotType", Args::Args(&[DType(CString)]), Ck3(AgentSlotType)),
    ...
    ("GetConnectionArrowType", Args::Args(&[DType(Unknown)]), Ck3(ConnectionArrowType)),
    ...
    ("GetCourtGrandeurDiffFromExpectedLevelModifier", Args::Args(&[DType(int32)]), Ck3(StaticModifier)),
    ("GetCourtGrandeurLevelModifier", Args::Args(&[DType(int32)]), Ck3(StaticModifier)),
    ...
    ("GetCourtType", Args::Args(&[DType(CString)]), Ck3(CourtType)),
    ("GetCultureByKey", Args::Args(&[DType(CString)]), Ck3(Culture)),
    ...
    ("GetCulturePillar", Args::Args(&[DType(CString)]), Ck3(CulturePillar)),
    ("GetCultureTemplate", Args::Args(&[IType(Item::Culture)]), Ck3(CultureTemplate)),
    ("GetCultureTradition", Args::Args(&[DType(CString)]), Ck3(CultureTradition)),
    ...
    ("GetDomicileBuilding", Args::Args(&[DType(CString)]), Ck3(DomicileBuilding)),
    ("GetDomicileType", Args::Args(&[DType(Unknown)]), Ck3(DomicileType)),
    ("GetDynastyByID", Args::Args(&[DType(CString)]), Ck3(Dynasty)),
    ("GetDynastyHouseByID", Args::Args(&[DType(CString)]), Ck3(DynastyHouse)),
    ...
    ("GetDynastyPerk", Args::Args(&[DType(CString)]), Ck3(DynastyPerk)),
    ...
    ("GetFaithType", Args::Args(&[DType(Unknown)]), Ck3(FaithType)),
    ...
    ("GetGreatProjectType", Args::Args(&[DType(CString)]), Ck3(GreatProjectType)),
    ("GetHoldingType", Args::Args(&[DType(Unknown)]), Ck3(HoldingType)),
    ("GetHolySite", Args::Args(&[IType(Item::HolySite)]), Ck3(HolySite)),
    ("GetHouseAspiration", Args::Args(&[DType(CString)]), Ck3(HouseAspiration)),
    ("GetHouseRelationLevel", Args::Args(&[DType(Unknown)]), Ck3(HouseRelationLevel)),
    ("GetHouseRelationType", Args::Args(&[DType(Unknown)]), Ck3(HouseRelationType)),
    ...
    ("GetLaw", Args::Args(&[DType(CString)]), Ck3(Law)),
    ("GetLawGroup", Args::Args(&[DType(CString)]), Ck3(LawGroup)),
    ...
    ("GetMapMode", Args::Args(&[DType(CString)]), Ck3(MapMode)),
    ("GetMenAtArmsType", Args::Args(&[DType(Unknown)]), Ck3(MenAtArmsType)),
    ("GetMeritModifierByLevel", Args::Args(&[DType(int32)]), Ck3(StaticModifier)),
    ...
    ("GetPlayersRulerObjectiveDecision", Args::Args(&[]), Ck3(Decision)),
    ...
    ("GetReligionFamily", Args::Args(&[DType(CString)]), Ck3(ReligionFamily)),
    ("GetReligionType", Args::Args(&[DType(Unknown)]), Ck3(ReligionType)),
    ...
    ("GetScriptedCharacterByHistoryID", Args::Args(&[DType(CString)]), Ck3(Character)),
    ...
    ("GetSituationOfType", Args::Args(&[DType(Ck3(SituationType))]), Ck3(Situation)),
    ("GetSituationType", Args::Args(&[DType(CString)]), Ck3(SituationType)),
    ("GetStaticModifier", Args::Args(&[IType(Item::Modifier)]), Ck3(StaticModifier)),
    ("GetStruggle", Args::Args(&[DType(CString)]), Ck3(Struggle)),
    ("GetStrugglePhase", Args::Args(&[DType(Unknown)]), Ck3(StrugglePhase)),
    ("GetStruggleType", Args::Args(&[DType(Unknown)]), Ck3(StruggleType)),
    ("GetSubjectContractGroup", Args::Args(&[DType(CString)]), Ck3(SubjectContractGroup)),
    ("GetSubjectContractType", Args::Args(&[DType(CString)]), Ck3(SubjectContractType)),
    ("GetSuggestionType", Args::Args(&[DType(Unknown)]), Ck3(SuggestionType)),
    ("GetTaskContractType", Args::Args(&[DType(CString)]), Ck3(TaskContractType)),
    ...
    ("GetTravelOption", Args::Args(&[DType(CString)]), Ck3(TravelOption)),
    ...
    ("HOUSE_ASPIRATION_TYPE", Args::Args(&[]), Ck3(HouseAspiration)),
    ("HOUSE_RELATION", Args::Args(&[]), Ck3(HouseRelation)),
    ("HOUSE_RELATION_LEVEL", Args::Args(&[]), Ck3(HouseRelationLevel)),
    ("HOUSE_RELATION_TYPE", Args::Args(&[]), Ck3(HouseRelationType)),
    ...
    ("NEW_HOUSE_RELATION_LEVEL", Args::Args(&[]), Ck3(HouseRelationLevel)),
    ("OLD_HOUSE_RELATION_LEVEL", Args::Args(&[]), Ck3(HouseRelationLevel)),
    ("OLD_LAW", Args::Args(&[]), Ck3(Law)),
    ...
    ("PdxAccount", Args::Args(&[]), Ck3(PdxAccount)),

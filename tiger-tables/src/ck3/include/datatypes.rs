...
pub enum Ck3Datatype {
    ...
    AIWatchWindow,
    Accolade,
    AccoladeAttributeSelectionView,
    ...
    DockableWindow,
    DoctrineCategoryFetcher,
    DoctrineCategoryHelper,
    ...
    KeyframeWidget,
    KillListWindow,
    KnightPermissionHouseFilterOption,
    KnightPermissionVassalFilterOption,
    KnightPermissions,
    KnightsView,
    KurultaiSuccession,
    ...
    LedgerCharacterItem,
    LedgerCultureItem,
    LedgerDynastyHouseItem,
    LedgerDynastyItem,
    LedgerFaithItem,
    LedgerListFilter,
    LedgerListFilterOption,
    LedgerProvinceItem,
    LedgerReligionItem,
    LedgerTitleItem,
    LedgerWarItem,
    ...
    SteppeWindow,
    Story,
    StoryCycleCounterVisualization,
    StoryCycleVariableVisualization,
    StoryInfo,
    StraitMapIcon,
    Struggle,

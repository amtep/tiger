...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::None, "complete_great_project", Scope(Scopes::GreatProjectType)),
    (Scopes::None, "complete_great_project_animated", Scope(Scopes::GreatProjectType)),
    ...
    (Scopes::None, "send_china_tutorial_finished_telemitry", Yes),
    (Scopes::None, "send_china_tutorial_started_telemitry", Yes),
    ...
    (Scopes::Character, "set_activity_intent", Item(Item::ActivityIntent)),
    ...
    (Scopes::LandedTitle, "set_vassal_wars_are_redirected_to_holder", Boolean),

...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::LandedTitle, "are_vassal_wars_redirected_to_holder", Boolean),
    ...
    (Scopes::DynastyHouse, "has_same_house_power_as", Scope(Scopes::DynastyHouse)),
    ...
    (
        ...
        Item(Item::SituationPhaseParameter),
    ),

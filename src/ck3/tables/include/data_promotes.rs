&[
    ...
    ("GetGroupingHelper", Ck3(FaithCreationWindow), Args::Args(&[DType(CString)]), Ck3(DoctrineGroupingFetcher)),
    ("GetGroupingHelper", Ck3(FaithWindow), Args::Args(&[DType(CString)]), Ck3(DoctrineGroupingFetcher2)),

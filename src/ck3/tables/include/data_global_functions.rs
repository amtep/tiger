&[
    ...
    ("DefaultOnBarterClick", Args::Args(&[DType(Unknown)]), void),
    ...
    ("GetHouseAspiration", Args::Args(&[DType(Unknown)]), Ck3(HouseAspiration)),
    ...
    ("GetMaxAppointmentRankDescription", Args::Args(&[DType(Unknown), DType(Unknown)]), CString),
    ("GetMaxStress", Args::Args(&[]), int32),
    ("GetMenAtArmsType", Args::Args(&[DType(Unknown)]), Ck3(MenAtArmsType)),
    ("GetMeritLevelEffects", Args::Args(&[DType(Unknown)]), CString),
    ("GetMeritLevelName", Args::Args(&[DType(Unknown)]), CString),
    ("GetMeritLevelNameNoTooltip", Args::Args(&[DType(Unknown)]), CString),
    ("GetMeritLevelShortNameNoTooltip", Args::Args(&[DType(Unknown)]), CString),
    ("GetMeritLevelThreshold", Args::Args(&[DType(Unknown)]), CFixedPoint),
    ...
    ("GetOpinionTint", Args::Args(&[DType(Unknown)]), CVector4f),
    ...
    ("GetString_CUTF8String", Args::Args(&[DType(Unknown)]), CString),
    ...
    ("GetW_CVector4f", Args::Args(&[DType(Unknown)]), float),
    ("GetW_CVector4i", Args::Args(&[DType(Unknown)]), int32),
    ("GetX_CVector2f", Args::Args(&[DType(Unknown)]), float),
    ("GetX_CVector2i", Args::Args(&[DType(Unknown)]), int32),
    ("GetX_CVector3f", Args::Args(&[DType(Unknown)]), float),
    ("GetX_CVector3i", Args::Args(&[DType(Unknown)]), int32),
    ("GetX_CVector4f", Args::Args(&[DType(Unknown)]), float),
    ("GetX_CVector4i", Args::Args(&[DType(Unknown)]), int32),
    ("GetY_CVector2f", Args::Args(&[DType(Unknown)]), float),
    ("GetY_CVector2i", Args::Args(&[DType(Unknown)]), int32),
    ("GetY_CVector3f", Args::Args(&[DType(Unknown)]), float),
    ("GetY_CVector3i", Args::Args(&[DType(Unknown)]), int32),
    ("GetY_CVector4f", Args::Args(&[DType(Unknown)]), float),
    ("GetY_CVector4i", Args::Args(&[DType(Unknown)]), int32),
    ("GetZ_CVector3f", Args::Args(&[DType(Unknown)]), float),
    ("GetZ_CVector3i", Args::Args(&[DType(Unknown)]), int32),
    ("GetZ_CVector4f", Args::Args(&[DType(Unknown)]), float),
    ("GetZ_CVector4i", Args::Args(&[DType(Unknown)]), int32),
    ...
    ("IsSituationPriority", Args::Args(&[DType(Unknown), DType(Unknown)]), bool),
    ("IsStrugglePriority", Args::Args(&[DType(Unknown), DType(Unknown)]), bool),
    ...
    ("OpenGuiTab", Args::Args(&[DType(Unknown), DType(Unknown)]), void),
    ...
    ("PinSituation", Args::Args(&[DType(Unknown), DType(Unknown)]), Ck3(Command)),
    ("PinStruggle", Args::Args(&[DType(Unknown), DType(Unknown)]), Ck3(Command)),
    ...
    ("PreSelectDecisionOption", Args::Args(&[DType(Unknown)]), void),
    ...
    ("SetAdminVassalDetailCandidate", Args::Args(&[DType(Unknown)]), void),
    ...
    ("ToggleMapMode", Args::Args(&[DType(Unknown)]), void),
    ...
    ("TrimBack", Args::Args(&[DType(Unknown)]), CString),

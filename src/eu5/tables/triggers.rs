...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::Location.union(Scopes::Area), "adjacent_to_owned_by", UncheckedTodo),
    (Scopes::Location.union(Scopes::Area), "adjacent_to_owned_or_owned_by_subject", UncheckedTodo),
    (Scopes::Character, "adm", UncheckedTodo),
    (Scopes::Character, "age_in_days", UncheckedTodo),
    (Scopes::Character, "age_in_years", UncheckedTodo),
    (Scopes::Country, "age_preference", UncheckedTodo),
    (Scopes::ParliamentAgenda, "agenda_for_estate_type", UncheckedTodo),
    (Scopes::ParliamentAgenda, "agenda_for_special_status", UncheckedTodo),
    (Scopes::None, "ai_issue_voting_bias", UncheckedTodo),
    (Scopes::ParliamentIssue, "ai_parliament_issue_resolution_vote_bias", UncheckedTodo),
    ...
    (Scopes::None, "ai_will_do", UncheckedTodo),
    (Scopes::None, "all_false", UncheckedTodo),
    (Scopes::Country, "allows_female_rulers", UncheckedTodo),
    (Scopes::Country, "allows_male_rulers", UncheckedTodo),
    (Scopes::None, "always", UncheckedTodo),
    (Scopes::EstateType, "always_loyal", UncheckedTodo),
    (Scopes::None, "and", UncheckedTodo),
    (Scopes::Country, "annexation_cost", UncheckedTodo),
    (Scopes::Country, "antagonism", UncheckedTodo),
    (Scopes::Area, "area_average_control", UncheckedTodo),
    (Scopes::Area, "area_average_integration", UncheckedTodo),
    (Scopes::Area, "area_exploration_progress", UncheckedTodo),
    (Scopes::Country, "army_maintenance", UncheckedTodo),
    (Scopes::Country, "army_size", UncheckedTodo),
    (Scopes::Country, "army_size_percentage", UncheckedTodo),
    (Scopes::Country.union(Scopes::InternationalOrganization), "army_tradition", UncheckedTodo),
    (
        Scopes::Country.union(Scopes::InternationalOrganization),
        "army_tradition_percentage",
        UncheckedTodo,
    ),
    (Scopes::Character, "art_progress", UncheckedTodo),
    (Scopes::WorkOfArt, "art_quality", UncheckedTodo),
    (Scopes::Character, "artist_skill", UncheckedTodo),
    (Scopes::Character, "artist_type", UncheckedTodo),
    (Scopes::None, "assert_if", UncheckedTodo),
    (Scopes::None, "assert_read", UncheckedTodo),
    (Scopes::Country, "at_war", UncheckedTodo),
    (Scopes::Market, "available_merchant_capacity", UncheckedTodo),
    (Scopes::Country, "average_control_in_home_region", UncheckedTodo),
    (Scopes::Country, "average_country_literacy", UncheckedTodo),
    (Scopes::Country, "average_estate_satisfaction", UncheckedTodo),
    (Scopes::Location, "average_location_literacy", UncheckedTodo),
    (Scopes::Location, "average_satisfaction", UncheckedTodo),
    (Scopes::InternationalOrganization, "average_special_status_power", UncheckedTodo),
    (Scopes::Siege, "besieger_strength", UncheckedTodo),
    (
        Scopes::Location.union(Scopes::Country).union(Scopes::Province),
        "border_distance_to",
        UncheckedTodo,
    ),
    (Scopes::Building.union(Scopes::BuildingType), "building_category", UncheckedTodo),
    (Scopes::Location, "building_efficiency", UncheckedTodo),
    (Scopes::Building, "building_employed_amount", UncheckedTodo),
    (Scopes::Building, "building_employment_size_amount", UncheckedTodo),
    (Scopes::Building, "building_goods_input", UncheckedTodo),
    (Scopes::Building, "building_index", UncheckedTodo),
    (Scopes::Building, "building_level", UncheckedTodo),
    (Scopes::Building, "building_levels_under_construction", UncheckedTodo),
    (Scopes::BuildingType, "building_manpower_produced", UncheckedTodo),
    (Scopes::Building, "building_max_level", UncheckedTodo),
    (Scopes::Building, "building_pop_type", UncheckedTodo),
    (Scopes::Building, "building_potential_profit", UncheckedTodo),
    (Scopes::Building, "building_produced_goods", UncheckedTodo),
    (Scopes::Building, "building_profit", UncheckedTodo),
    (Scopes::BuildingType, "building_sailors_produced", UncheckedTodo),
    (Scopes::Country, "building_type_is_obsolete", UncheckedTodo),
    (Scopes::Location, "building_type_max_level", UncheckedTodo),
    (Scopes::CabinetAction, "cabinet_action_type", UncheckedTodo),
    (Scopes::None, "calc_true_if", UncheckedTodo),
    (Scopes::None, "can_add_relation", UncheckedTodo),
    (Scopes::InternationalOrganization, "can_annex_members", UncheckedTodo),
    (Scopes::ParliamentAgenda, "can_be_bribe", UncheckedTodo),
    (Scopes::SubjectType, "can_be_force_broken_in_peace_treaty", UncheckedTodo),
    (Scopes::Location, "can_become_rank", UncheckedTodo),
    (Scopes::Location.union(Scopes::Country), "can_build_building", UncheckedTodo),
    (Scopes::Country, "can_build_unit_type", UncheckedTodo),
    (Scopes::Country, "can_build_units_of_category", UncheckedTodo),
    (Scopes::Country, "can_create_casus_belli_of_type_on", UncheckedTodo),
    ...
    (Scopes::Character, "dip", UncheckedTodo),
    ...
    (Scopes::Character, "mil", UncheckedTodo),
    ...
    (Scopes::Country, "monthly_balance", UncheckedTodo),
    (Scopes::Location, "monthly_conversion", UncheckedTodo),
    (Scopes::Mercenary, "monthly_cost", UncheckedTodo),
    (Scopes::Country, "monthly_income_total", UncheckedTodo),
    (Scopes::Country, "monthly_income_trade_and_tax", UncheckedTodo),
    (Scopes::Country, "monthly_manpower", UncheckedTodo),
    (Scopes::Country, "monthly_sailors", UncheckedTodo),
    (Scopes::Country, "monthly_trade_income", UncheckedTodo),
    ...
    (Scopes::None, "nand", UncheckedTodo),
    ...
    (Scopes::None, "nor", UncheckedTodo),
    (Scopes::None, "not", UncheckedTodo),
    (Scopes::Country, "num_adult_capable_characters", UncheckedTodo),
    (Scopes::DiseaseOutbreak, "num_affected_locations", UncheckedTodo),
    (Scopes::Location, "num_army_constructions", UncheckedTodo),
    (Scopes::Country, "num_artists", UncheckedTodo),
    (Scopes::Country, "num_avatars", UncheckedTodo),
    (Scopes::Location, "num_buildings", UncheckedTodo),
    (Scopes::Country, "num_cardinals", UncheckedTodo),
    (Scopes::Country, "num_characters", UncheckedTodo),
    (Scopes::Location, "num_civil_constructions", UncheckedTodo),
    (Scopes::Country, "num_colonial_charters", UncheckedTodo),
    (Scopes::Religion, "num_countries_in_religion", UncheckedTodo),
    (Scopes::InternationalOrganization, "num_countries_with_special_status", UncheckedTodo),
    (Scopes::Country, "num_embraced_institutions", UncheckedTodo),
    (Scopes::Country, "num_explorations", UncheckedTodo),
    (Scopes::Location, "num_foreign_buildings", UncheckedTodo),
    (Scopes::Country, "num_forts", UncheckedTodo),
    (Scopes::Country, "num_known_institutions", UncheckedTodo),
    (Scopes::Country, "num_loans", UncheckedTodo),
    (Scopes::Country, "num_locations", UncheckedTodo),
    (Scopes::Country, "num_locations_owned_or_owned_by_subjects", UncheckedTodo),
    (Scopes::Country, "num_locations_owned_or_owned_by_subjects_or_below", UncheckedTodo),
    (Scopes::Location, "num_navy_constructions", UncheckedTodo),
    (
        Scopes::Country.union(Scopes::InternationalOrganization),
        "num_of_active_parliament_agendas",
        UncheckedTodo,
    ),
    (Scopes::Country, "num_of_advances_researched", UncheckedTodo),
    (Scopes::Character, "num_of_children", UncheckedTodo),
    (Scopes::Country, "num_of_diplomats", UncheckedTodo),
    (Scopes::InternationalOrganization, "num_of_electors", UncheckedTodo),
    (Scopes::Country, "num_of_locations_owned_by_io", UncheckedTodo),
    (Scopes::Country, "num_of_markets_with_merchants", UncheckedTodo),
    (Scopes::Country, "num_of_non_rural", UncheckedTodo),
    (Scopes::Country, "num_of_non_rural_ports", UncheckedTodo),
    (Scopes::Country, "num_of_ports", UncheckedTodo),
    (Scopes::Rebels, "num_of_rebel_characters", UncheckedTodo),
    (Scopes::Rebels, "num_of_rebel_supporters", UncheckedTodo),
    (Scopes::Country, "num_of_religious_aspects", UncheckedTodo),
    (Scopes::Character, "num_of_spouses", UncheckedTodo),
    (Scopes::Country, "num_of_trades", UncheckedTodo),
    (Scopes::Character, "num_of_traits", UncheckedTodo),
    (Scopes::Character, "num_of_traits_of_category", UncheckedTodo),
    (Scopes::Country, "num_open_reform_slots", UncheckedTodo),
    (Scopes::Country.union(Scopes::Estate), "num_possible_privileges", UncheckedTodo),
    (Scopes::Country, "num_possible_rivals", UncheckedTodo),
    (Scopes::Country.union(Scopes::Estate), "num_privileges", UncheckedTodo),
    (Scopes::Area, "num_province_definitions_in_area", UncheckedTodo),
    (Scopes::Country, "num_provinces", UncheckedTodo),
    (Scopes::Country, "num_rebels", UncheckedTodo),
    (Scopes::Country, "num_reforms", UncheckedTodo),
    (Scopes::Country, "num_regiments", UncheckedTodo),
    (Scopes::Country, "num_relations_above_limit", UncheckedTodo),
    (Scopes::Country, "num_rivals", UncheckedTodo),
    (Scopes::Location, "num_roads", UncheckedTodo),
    (Scopes::Country, "num_subjects", UncheckedTodo),
    (Scopes::Unit, "num_subunits", UncheckedTodo),
    (Scopes::Dynasty, "num_union_countries", UncheckedTodo),
    (Scopes::Dynasty, "num_unions", UncheckedTodo),
    (Scopes::Country, "num_works_of_art", UncheckedTodo),
    ...
    (Scopes::Country, "regular_army_size", UncheckedTodo),

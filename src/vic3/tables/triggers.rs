...
const TRIGGER: &[(Scopes, &str, Trigger)] = &[
    ...
    (Scopes::Ship, "days_obsolete", Removed("1.13.8", "")),
    ...
    (Scopes::Ship, "is_ship_obsolete_for", Scope(Scopes::Country)),
    (Scopes::Ship, "is_ship_type", Scope(Scopes::ShipType)),
    (Scopes::Ship, "is_ship_very_obsolete_for", Scope(Scopes::Country)),

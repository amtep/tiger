...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::Character, "add_career_length", UncheckedTodo),
    ...
    (Scopes::Country, "add_declared_interest", Removed("1.13.0", "")),
    ...
    (Scopes::Country, "add_involvement", UncheckedTodo),
    ...
    (Scopes::State.union(Scopes::StateRegion), "add_resource_potential", UncheckedTodo),
    (Scopes::InterestGroup, "add_ruling_interest_group", Boolean),
    (Scopes::StateRegion, "add_state_trait", Item(Item::StateTrait)),
    (Scopes::Country, "add_supply_ships", UncheckedTodo),
    ...
    (Scopes::State.union(Scopes::StateRegion), "change_resource_potential", UncheckedTodo),
    ...
    (Scopes::Country, "clear_ownership_transfer_fleet", UncheckedTodo),
    ...
    (Scopes::None, "custom_label_no_bullet", UncheckedTodo),
    (Scopes::None, "custom_tooltip", ControlOrLabel),
    (Scopes::None, "custom_tooltip_no_bullet", UncheckedTodo),
    (Scopes::Ship, "damage_ship_hull", UncheckedTodo),
    (Scopes::Ship, "damage_ship_hull_percent", UncheckedTodo),
    ...
    (Scopes::Country, "disable_temporary_hostilities", UncheckedTodo),
    ...
    (Scopes::Country, "enable_temporary_hostilities", UncheckedTodo),
    ...
    (Scopes::Ship, "kill_crew", UncheckedTodo),
    (Scopes::Ship, "kill_crew_percent", UncheckedTodo),
    ...
    (Scopes::Ship, "kill_ship", UncheckedTodo),
    ...
    (Scopes::Culture, "remove_cultural_taboo", UncheckedTodo),
    ...
    (Scopes::State.union(Scopes::StateRegion), "remove_resource_potential", UncheckedTodo),
    ...
    (Scopes::Character, "replace_character_roles", UncheckedTodo),
    ...
    (Scopes::Character, "retire_character_if_should_be_culled", UncheckedTodo),
    ...
    (Scopes::Character, "set_as_adult", UncheckedTodo),
    (Scopes::Ship, "set_as_flagship", UncheckedTodo),
    ...
    (Scopes::Character, "set_career_length", UncheckedTodo),
    ...
    (Scopes::Character, "set_home_state", UncheckedTodo),
    ...
    (Scopes::Character, "set_is_noble", UncheckedTodo),
    (Scopes::DiplomaticPlay, "set_key", Item(Item::Localization)),
    (Scopes::Character, "set_last_name", UncheckedTodo),
    ...
    (Scopes::Culture, "set_name_format", UncheckedTodo),
    ...
    (Scopes::Ship, "set_ship_owner", UncheckedTodo),
    (Scopes::Ship, "set_ship_owner_multiple", UncheckedTodo),
    ...
    (Scopes::StateRegion, "start_harvest_condition_with_params", UncheckedTodo),
    ...
    (Scopes::Character, "unassign_from_formation", UncheckedTodo),

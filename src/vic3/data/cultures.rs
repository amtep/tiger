...
impl DbKind for Culture {
    fn validate(&self, key: &Token, block: &Block, data: &Everything) {
        ...
        vd.multi_field_list_items("traditions", Item::TraditionTrait);

        vd.multi_field_list_items("male_common_first_names", Item::Localization);
        vd.multi_field_list_items("female_common_first_names", Item::Localization);
        vd.multi_field_list_items("male_noble_first_names", Item::Localization);
        vd.multi_field_list_items("female_noble_first_names", Item::Localization);
        vd.multi_field_list_items("male_regal_first_names", Item::Localization);
        vd.multi_field_list_items("female_regal_first_names", Item::Localization);
        vd.multi_field_list_items("common_last_names", Item::Localization);
        vd.multi_field_list_items("noble_last_names", Item::Localization);

...
bitflags! {
    ...
    pub struct Scopes: ScopesBits {
        ...
        #[cfg(feature = "vic3")] const CivilWar = 1<<20;
        #[cfg(feature = "vic3")] const CulturalCommunity = 1<<21;
        #[cfg(feature = "vic3")] const NewCombatUnit = 1<<22;
        #[cfg(feature = "vic3")] const CommanderOrderType = 1<<23;
        #[cfg(feature = "vic3")] const CountryCreation = 1<<24;
        #[cfg(feature = "vic3")] const CountryDefinition = 1<<25;
        #[cfg(feature = "vic3")] const CountryFormation = 1<<26;
        #[cfg(feature = "vic3")] const Decree = 1<<27;
        #[cfg(feature = "vic3")] const DiplomaticAction = 1<<28;
        #[cfg(feature = "vic3")] const DiplomaticPact = 1<<29;
        #[cfg(feature = "vic3")] const DiplomaticPlay = 1<<30;
        #[cfg(feature = "vic3")] const DiplomaticRelations = 1<<31;
        #[cfg(feature = "vic3")] const Front = 1<<32;
        #[cfg(feature = "vic3")] const Goods = 1<<33;
        #[cfg(feature = "vic3")] const Hq = 1<<34;
        #[cfg(feature = "vic3")] const Ideology = 1<<35;
        #[cfg(feature = "vic3")] const Institution = 1<<36;
        #[cfg(feature = "vic3")] const InstitutionType = 1<<37;
        #[cfg(feature = "vic3")] const InterestMarker = 1<<38;
        #[cfg(feature = "vic3")] const InterestGroup = 1<<39;
        #[cfg(feature = "vic3")] const InterestGroupTrait = 1<<40;
        #[cfg(feature = "vic3")] const InterestGroupType = 1<<41;
        #[cfg(feature = "vic3")] const JournalEntry = 1<<42;
        #[cfg(feature = "vic3")] const Law = 1<<43;
        #[cfg(feature = "vic3")] const LawType = 1<<44;
        #[cfg(feature = "vic3")] const Market = 1<<45;
        #[cfg(feature = "vic3")] const MarketGoods = 1<<46;
        #[cfg(feature = "vic3")] const Objective = 1<<47;
        #[cfg(feature = "vic3")] const PoliticalMovement = 1<<48;
        #[cfg(feature = "vic3")] const PopType = 1<<49;
        #[cfg(feature = "vic3")] const ShippingLanes = 1<<50;
        #[cfg(feature = "vic3")] const StateRegion = 1<<51;
        #[cfg(feature = "vic3")] const StateTrait = 1<<52;
        #[cfg(feature = "vic3")] const Technology = 1<<53;
        #[cfg(feature = "vic3")] const TechnologyStatus = 1<<54;
        #[cfg(feature = "vic3")] const Theater = 1<<55;
        #[cfg(feature = "vic3")] const CombatUnitType = 1<<56;
        #[cfg(feature = "vic3")] const MilitaryFormation = 1<<57;
        #[cfg(feature = "vic3")] const Sway = 1<<58;
        #[cfg(feature = "vic3")] const StateGoods = 1<<59;
        #[cfg(feature = "vic3")] const DiplomaticDemand = 1<<60;
        #[cfg(feature = "vic3")] const Company = 1<<61;
        #[cfg(feature = "vic3")] const CompanyType = 1<<62;
        #[cfg(feature = "vic3")] const TravelNode = 1<<63;
        #[cfg(feature = "vic3")] const TravelNodeDefinition = 1<<64;
        #[cfg(feature = "vic3")] const TravelConnection = 1<<65;
        #[cfg(feature = "vic3")] const TravelConnectionDefinition = 1<<66;
        #[cfg(feature = "vic3")] const Invasion = 1<<67;
        #[cfg(feature = "vic3")] const MobilizationOption = 1<<68;
        #[cfg(feature = "vic3")] const PowerBlocPrincipleGroup = 1<<69;
        #[cfg(feature = "vic3")] const DiplomaticPlayType = 1<<70;
        #[cfg(feature = "vic3")] const DiplomaticCatalyst = 1<<71;
        #[cfg(feature = "vic3")] const DiplomaticCatalystType = 1<<72;
        #[cfg(feature = "vic3")] const DiplomaticCatalystCategory = 1<<73;
        #[cfg(feature = "vic3")] const PoliticalLobby = 1<<74;
        #[cfg(feature = "vic3")] const PoliticalLobbyType = 1<<75;
        #[cfg(feature = "vic3")] const PoliticalLobbyAppeasement = 1<<76;
        #[cfg(feature = "vic3")] const PowerBloc = 1<<77;
        #[cfg(feature = "vic3")] const PowerBlocIdentity = 1<<78;
        #[cfg(feature = "vic3")] const PowerBlocPrinciple = 1<<79;
        #[cfg(feature = "vic3")] const HarvestCondition = 1<<80;
        #[cfg(feature = "vic3")] const PoliticalMovementType = 1<<81;
        #[cfg(feature = "vic3")] const HarvestConditionType = 1<<82;
        #[cfg(feature = "vic3")] const TreatyArticle = 1<<83;
        #[cfg(feature = "vic3")] const TreatyOptions = 1<<84;
        #[cfg(feature = "vic3")] const TreatyArticleOptions = 1<<85;
        #[cfg(feature = "vic3")] const Treaty = 1<<86;
        #[cfg(feature = "vic3")] const BuildingGroup = 1<<87;
        #[cfg(feature = "vic3")] const Amendment = 1<<88;
        #[cfg(feature = "vic3")] const AmendmentType = 1<<89;
        #[cfg(feature = "vic3")] const GeographicRegion = 1<<90;
        #[cfg(feature = "vic3")] const WarGoal = 1<<91;
        #[cfg(feature = "vic3")] const WarGoalType = 1<<92;
        #[cfg(feature = "vic3")] const CharacterRole = 1<<93;
        ...
        #[cfg(feature = "vic3")] const ShipType = 1<<100;
        #[cfg(feature = "vic3")] const Strait = 1<<101;
        #[cfg(feature = "vic3")] const StraitType = 1<<102;
        #[cfg(feature = "vic3")] const ShipModificationType = 1<<103;

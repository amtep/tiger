...
const MODIF_TABLE: &[(&str, ModifKinds)] = &[
    ("happiness_for_wrong_religion_modifier", ModifKinds::Country),
    ...
    ("land_unit_attrition", ModifKinds::Country.union(ModifKinds::Unit)),
    ("naval_unit_attrition", ModifKinds::Country.union(ModifKinds::Unit)),
    ("army_weight_modifier", ModifKinds::Country.union(ModifKinds::Unit)),
    ("navy_weight_modifier", ModifKinds::Country.union(ModifKinds::Unit)),
    ...
    ("army_movement_speed", ModifKinds::Unit.union(ModifKinds::Country)),
    ("navy_movement_speed", ModifKinds::Unit.union(ModifKinds::Country)),
    ("movement_speed_if_no_road", ModifKinds::Unit.union(ModifKinds::Country)),
    ...
    ("discipline", ModifKinds::Country.union(ModifKinds::Unit)),
    ("local_defensive", ModifKinds::Province.union(ModifKinds::State)),
    ("global_defensive", ModifKinds::Country),
    ("commerce_value", ModifKinds::Province.union(ModifKinds::State)),
    ...
    ("monthly_governor_wage", ModifKinds::Country.union(ModifKinds::Character)),
    (
        "monthly_local_governor_wage",
        ModifKinds::Province.union(ModifKinds::State).union(ModifKinds::Country),
    ),
    ("monthly_character_popularity", ModifKinds::Character.union(ModifKinds::Country)),
    ("monthly_character_popularity_decay", ModifKinds::Character.union(ModifKinds::Country)),
    ("monthly_character_prominence", ModifKinds::Character.union(ModifKinds::Country)),
    ("monthly_character_fam_prestige", ModifKinds::Character.union(ModifKinds::Country)),
    ("cohort_reinforcement_speed", ModifKinds::Country.union(ModifKinds::Unit)),
    ("land_morale_recovery", ModifKinds::Country.union(ModifKinds::Unit)),
    ("naval_morale_recovery", ModifKinds::Country.union(ModifKinds::Unit)),
    ("siege_ability", ModifKinds::Country.union(ModifKinds::Unit)),
    ("assault_ability", ModifKinds::Country.union(ModifKinds::Unit)),
    ("siege_engineers", ModifKinds::Country.union(ModifKinds::Legion)),
    ...
    ("current_corruption", ModifKinds::Character.union(ModifKinds::Country)),
    ...
    ("fort_maintenance_cost", ModifKinds::Country.union(ModifKinds::State)),
    ("army_maintenance_cost", ModifKinds::Country.union(ModifKinds::Unit)),
    ("navy_maintenance_cost", ModifKinds::Country.union(ModifKinds::Unit)),
    ...
    ("experience_decay", ModifKinds::Country.union(ModifKinds::Unit)),
    ("monthly_experience_gain", ModifKinds::Country.union(ModifKinds::Unit)),
    ("martial", ModifKinds::Character),
    ("finesse", ModifKinds::Character),
    ("charisma", ModifKinds::Character),
    ("zeal", ModifKinds::Character),
    ("fertility", ModifKinds::Character.union(ModifKinds::Country)),
    ("health", ModifKinds::Character.union(ModifKinds::Country)),
    ("barbarian_growth", ModifKinds::Province),
    ("barbarian_spawn_chance", ModifKinds::Province.union(ModifKinds::State)),
    (
        "loyalty_gain_chance",
        ModifKinds::Country.union(ModifKinds::Character).union(ModifKinds::Unit),
    ),
    (
        "loyalty_gain_chance_modifier",
        ModifKinds::Country.union(ModifKinds::Character).union(ModifKinds::Unit),
    ),
    ("prominence", ModifKinds::Character.union(ModifKinds::Country)),
    ...
    ("show_3d_fort", ModifKinds::Province),
    ...
    ("primary_heir_attraction", ModifKinds::Character.union(ModifKinds::Country)),
    ...
    ("naval_damage_done", ModifKinds::Country.union(ModifKinds::Unit)),
    ("naval_damage_taken", ModifKinds::Country.union(ModifKinds::Unit)),
    ...
    ("cultural_integration_speed_modifier", ModifKinds::CountryCulture),
    ("cultural_assimilation_speed_modifier", ModifKinds::CountryCulture),
    ("culture_happiness_modifier", ModifKinds::CountryCulture),
    ...
    ("monthly_character_experience_decay", ModifKinds::Character.union(ModifKinds::Country)),
